...
class Pelanggan extends Model
{
     ...
     
     {
        ...
        $pel_id = $_POST['pel_id'];
         ...
         $sql = "INSERT INTO tb_pelanggan
             SET pel_id=:pel_id, pel_id_gol=:pel_id_gol, pel_no=:pel_no, pel_nama=:pel_nama, 
             pel_alamat=:pel_alamat, pel_hp=:pel_hp, pel_ktp=:pel_ktp, pel_seri=:pel_seri, pel_meteran=:pel_meteran,
     ...
     public function update()
     {
          ...
          SET pel_id_gol=:pel_id_gol, pel_no=:pel_no, pel_nama=:pel_nama, pel_alamat=:pel_alamat, pel_hp=:pel_hp, pel_ktp=:pel_ktp, pel_seri=:pel_seri, pel_meteran=:pel_meteran, pel_aktif=:pel_aktif, pel_id_user=:pel_id_user WHERE pel_id=:pel_id";
